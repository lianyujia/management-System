...
function validateForm() {
    ...
    if (password.length < 6 || !hasUpperCase || !hasLowerCase || !hasNumbers) {
        passwordError.textContent = "Password must be at least 6 characters long and include at least one uppercase letter, one lowercase letter, and one digit.";
        return false; // Prevent form submission
    }
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://static.vecteezy.com/system/resources/thumbnails/022/963/918/small_2x/ai-generative-cute-cat-isolated-on-solid-background-photo.jpg" alt=""/>
                        <h3>Welcome</h3>
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 43%;">
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Password *" id="password" name="password" onkeyup='check();' minlength="6" required/>
                                        </div>
                                        </form>
                                        <div class="form-group">
                                            <div class="maxl">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" pattern="\d{10}" placeholder="Your Phone *****" onkeyup="return alphaOnly(event);" required />
                                        </div>
                                        <div class="form-group">
